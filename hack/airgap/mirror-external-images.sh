...
echo ""
echo "NOTE: The gVisor 'runsc' binary is NOT a Docker image."
echo "  Download it and host it on your internal HTTP/S3 server:"
echo "    AMD64: gs://gvisor/releases/release/20260622/x86_64/runsc"
echo "    ARM64: gs://gvisor/releases/release/20260622/aarch64/runsc"
echo "  Then update manifests/airgap-install/04-sandboxconfig.yaml with your URLs."
echo ""
